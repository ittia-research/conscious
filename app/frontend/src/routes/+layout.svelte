...
<div class="min-h-screen flex flex-col bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100">
	<!-- Navigation Bar -->
	<nav class="bg-blue-600 dark:bg-blue-800 text-white shadow-md">
	...
	<main class="flex-grow container mx-auto px-4 py-8">
	  <slot /> <!-- This renders the content of your +page.svelte, etc. -->
	</main>
